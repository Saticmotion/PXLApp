...
public class DownloadKlassenLijstTask extends AsyncTask<String, Void, Void>{
	...
	protected Void doInBackground(String... params) {
		...
		String url = "https://kalender.phl.be/kalenterit2/index.php?kt=lk&av=140120140126140121&guest="+guest+"%2Fphl&lang=fla";
		
		try {
			ProgressDialog progress = new ProgressDialog(activiteit);
			...
			if(cacheString.length()!=0)
				cacheString = cacheString.substring(0,cacheString.length()-1); //laatste overbodige komma verwijderen
